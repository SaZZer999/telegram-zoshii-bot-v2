...
## Preview Edit Planner V2 (pending_inventory_transform) — не перевірено наживо (2026-07-14)
...
* **Не підтверджено наживо в Telegram** — перед оголошенням live-milestone потрібна ручна перевірка сценарію з активним transform-preview і природним/голосовим редагуванням.
