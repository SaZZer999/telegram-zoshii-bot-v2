...
## Inventory Delete Quantity-Match — виправлено (не перевірено наживо, 2026-07-13)
...
* **Не підтверджено наживо в Telegram** — перед оголошенням live-milestone потрібна ручна перевірка сценарію з реальними запасами.
